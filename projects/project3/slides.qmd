...
:::: {.columns}
::: {.column width="66%"}
![](assets/confirmation-blueberries.jpeg){fig-alt="Blueberries photo" .feature-figure}
:::
...
::: {.speaker-prompt}
**Why this example fits:** we may keep searching until we find an answer that supports what we already wanted to believe.
:::
:::
::::

::: {.notes}
A simple everyday example is checking how long blueberries last and scrolling until you find a result that matches what you hoped to see. That is confirmation bias in action.
:::
...
::: {.takeaway}
Biases and heuristics are part of everyday thinking. Better analysis comes from recognizing them early and building habits that reduce their effect.
:::

![](assets/bottom-photo.jpg){fig-alt="Person writing beside a laptop" .feature-figure}

::: {.notes}
I hope that knowing more about these effects will help you in your analytics journey. Thank you.
:::
...
![](assets/bottom-photo.jpg){fig-alt="Person writing beside a laptop" .feature-figure .feature-figure-small}
